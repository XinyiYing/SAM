...
parser.add_argument("--TrainSet", default="../data/train", type=str, help="Path of training dataset (default: 0)")
parser.add_argument("--ValidSet", default="../data/valid", type=str, help="Path of valid dataset (default: 0)")
parser.add_argument("--SavePath", default="./SavePath", type=str, help="Save path (default: 0)")
parser.add_argument("--scale", default=4, type=int, help="upscale factor (default: 0)")
...
def main():
    ...
    train_set = TrainSetLoader(opt.TrainSet, opt.scale)
...
def save_checkpoint_SAM(model, epoch):
    model_out_path = opt.SavePath + "model_epoch_{}.pth".format(epoch)
